...
var Router = (function () {
    ...
    Router.prototype.registerPrimaryOutlet = function (outlet) {
        if (lang_1.isPresent(outlet.name)) {
            throw new lang_1.BaseException("registerAuxOutlet expects to be called with an unnamed outlet.");
        }
        this._outlet = outlet;
    ...
    Router.prototype.registerAuxOutlet = function (outlet) {
        ...
        if (lang_1.isBlank(outletName)) {
            throw new lang_1.BaseException("registerAuxOutlet expects to be called with an outlet with a name.");
        }
        // TODO...
    ...
    Router.prototype._canReuse = function (instruction) {
        ...
        return this._outlet.canReuse(instruction.component)
            ...
            if (lang_1.isPresent(_this._childRouter) && lang_1.isPresent(instruction.child)) {
