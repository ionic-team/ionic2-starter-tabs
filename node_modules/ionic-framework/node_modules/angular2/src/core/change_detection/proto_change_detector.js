...
var DynamicProtoChangeDetector = (function () {
    function DynamicProtoChangeDetector(definition) {
        ...
        this._propertyBindingTargets = this.definition.bindingRecords.map(function (b) { return b.target; });
        this._directiveIndices = this.definition.directiveRecords.map(function (d) { return d.directiveIndex; });
    }
