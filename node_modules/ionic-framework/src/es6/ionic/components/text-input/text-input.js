...
import { Directive, Host, Optional, ElementRef, Attribute, Query, QueryList, NgZone } from 'angular2/angular2';
...
export let TextInputElement = class {
     ...
     */
    constructor(type, elementRef, config) {
        this.type = type;
...
TextInputElement = __decorate([
    ...
    __metadata('design:paramtypes', [String, (typeof ElementRef !== 'undefined' && ElementRef) || Object, (typeof IonicConfig !== 'undefined' && IonicConfig) || Object])
], TextInputElement);
/**
 * TODO
 */
export let TextInput = class extends Ion {
    /**
     * TODO
     * @param {ElementRef} elementRef  TODO
     * @param {IonicConfig} config  TODO
     ...
     */
    constructor(elementRef, config, app, ngZone, platform, scrollView, inputQry, labelQry) {
...
TextInput = __decorate([
    ...
    __param(5, Optional()),
    __param(5, Host()),
    __param(6, Query(TextInputElement)),
    __param(7, Query(Label)), 
    __metadata('design:paramtypes', [(typeof ElementRef !== 'undefined' && ElementRef) || Object, (typeof IonicConfig !== 'undefined' && IonicConfig) || Object, (typeof IonicApp !== 'undefined' && IonicApp) || Object, (typeof NgZone !== 'undefined' && NgZone) || Object, (typeof IonicPlatform !== 'undefined' && IonicPlatform) || Object, (typeof Content !== 'undefined' && Content) || Object, (typeof QueryList !== 'undefined' && QueryList) || Object, (typeof QueryList !== 'undefined' && QueryList) || Object])
], TextInput);
